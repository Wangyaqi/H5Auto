		...
		for(var k = artLayers.length - 1; k >= 0; k--) {
			if(artLayers[k].visible) {
				if(artLayers[k].name == "bg") {
					...
					style_ele_block_temp = style_ele_block_temp.replace(/{{style_ele_width}}/g, (style_ele_width / script_d_width * 100).toFixed(2) + "%")
					style_ele_block_temp = style_ele_block_temp.replace(/{{style_ele_left}}/g, (style_ele_left / script_d_width * 100).toFixed(2) + "%")
					style_ele_block_temp = style_ele_block_temp.replace(/{{style_ele_top}}/g, (style_ele_top / script_d_height * 100).toFixed(2) + "%")
