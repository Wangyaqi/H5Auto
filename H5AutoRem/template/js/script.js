...
function page_init() {
	...
	var box_scale = w_height / w_width > d_height / d_width ? 1 : w_height * d_width / d_height * w_width;
	$(".page_box").css({
		"height": d_height / rootsize + "rem",
		"top": (w_height/w_width*d_width - d_height) / 2 / rootsize + "rem",
		"transform-style": "preserve-3d",
		"-webkit-transform-style": "preserve-3d",
		"transform": "scale(" + box_scale + ")",
		"-webkit-transform": "scale(" + box_scale + ")"
	});
}
